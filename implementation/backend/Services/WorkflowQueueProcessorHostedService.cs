...
public sealed class WorkflowQueueProcessorHostedService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        {
            _logger.LogInformation("Workflow OTP dispatch queue URL not configured; queue processor is idle.");
            return;
        }

        _logger.LogInformation("Workflow queue processor started for OTP dispatch queue.");
