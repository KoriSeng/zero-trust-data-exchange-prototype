...
app.MapPost("/requests/{id}/approve", async (string id, ApproveRequestDto dto, HttpContext context, IDataService dataService, IStepFunctionsService stepFunctionsService, IAmazonSQS sqsClient, ILogger<Program> logger) =>
{
